    ...
    if (Array.isArray(dataArray)) {
      ...
      var linkElements = svg
        ...
        .attr("d", function (d) {
          return [
            "M",
            width / 2,
            startY + d.source * nodeSpacing,
            "A",
            (Math.abs(d.source - d.target) * nodeSpacing) / 2,
            (Math.abs(d.source - d.target) * nodeSpacing) / 2,
            0,
            0,
            d.source < d.target ? 0 : 1,
            width / 2,
            startY + d.target * nodeSpacing,
          ].join(" ");
        })
      ...
      legendContainer
        ...
        .each(function (d, i) {
          ...
          container.append("div").attr("class", "legend-label").text(d);
        });
    }
  };
